...
/**
 * NvConfiguration generated by hbm2java
 */
@Entity
@Table(name = "nv_configuration", catalog = "NVPrestashop")
public class NvConfiguration implements java.io.Serializable {
	...
	public NvConfiguration(String name, Date dateAdd, Date dateUpd) {
		this.name = name;
		this.dateAdd = dateAdd;
		this.dateUpd = dateUpd;
	}

	public NvConfiguration(Integer idShopGroup, Integer idShop, String name, String value, Date dateAdd, Date dateUpd) {
